    ...
    <div>
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-primary via-primary to-sidebar">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h1 className="font-display font-bold text-3xl text-white">Browse Tutors</h1>
          <p className="text-white/70 mt-1">Find the perfect peer tutor for your learning needs</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className={`lg:w-72 flex-shrink-0 ${showFilters ? 'block' : 'hidden lg:block'}`}>
            <div className="card space-y-6">
              <div className="flex items-center justify-between">
                ...
                {hasFilters && (
                  <button onClick={clearFilters} className="text-sm text-red-brand hover:underline">Clear all</button>
                )}
              </div>
                ...
                <div className="space-y-2">
                  {['all', 'online', 'in_person'].map(f => (
                    <label key={f} className="flex items-center gap-2 text-sm">
                      <input type="radio" name="format" value={f} checked={deliveryFormat === f} onChange={e => setDeliveryFormat(e.target.value)} className="text-orange-brand" />
          ...
          <div className="flex-1">
            ...
            <div className="mt-8 bg-gradient-to-r from-red-brand/5 via-orange-brand/5 to-accent/5 rounded-xl p-6 border border-orange-brand/10">
              <div className="flex items-start gap-4">
                ...
                <button onClick={() => setRequestModal(true)} className="bg-gradient-to-r from-red-brand to-orange-brand text-white px-4 py-2 rounded-lg font-medium text-sm whitespace-nowrap hover:opacity-90 transition-opacity">
                  Request a Skill
                </button>
              </div>
            </div>
